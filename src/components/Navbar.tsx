            ...
            <div className="flex items-center gap-4 ml-4">
              ...
              {user ? (
                <div className="flex items-center gap-4">
                  ...
                  <button onClick={handleLogout} className="flex items-center gap-2 px-3 py-2 text-gray-500 hover:text-red-500 hover:bg-red-50 rounded-xl transition-all group">
                    <LogOut size={18} />
